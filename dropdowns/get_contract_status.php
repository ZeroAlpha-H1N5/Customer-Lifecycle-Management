...
$conn = db_connect();
//----- Contract Status Dropdown Select -----//
...
$html = '<label for="contract_status_id">Contract Status:</label><br>';
$html .= '<select id="contract_status_id" name="contract_status_id">';
